...
let time = document.querySelector('#hiddenf');
...
document.addEventListener('DOMContentLoaded', () => {
     ...
     ScheduleDB.onupgradeneeded = function(e) {
          ...
          objectStore.createIndex('dose', 'dose', { unique: false } );
     ...
     function showConsultations() {
               ...
               if(cursor) {
                    ...
                    ConsultationHTML.innerHTML = `  
                         <p class="font-weight-bold">Patient Name:  <span class="font-weight-normal">${cursor.value.patientname}<span></p>
                          ...
                          <p class="font-weight-bold">Dose Number:  <span class="font-weight-normal">${cursor.value.dose}<span></p>
                 ...
                 consultations.appendChild(ConsultationHTML);
                    ...
                    if(!consultations.firstChild) {
                        services.textContent = 'Confirmed Bookings';
                      ...
                      consultations.appendChild(noSchedule);
                        ...
                        services.textContent = 'Booking Confirmed!'
                    }
               }
          }
     }
          ...
          transaction.oncomplete = () => {
               ...
               if(!consultations.firstChild) {
                   ...
                   services.textContent = 'Cancel your Booking'
               }
          }
     }
